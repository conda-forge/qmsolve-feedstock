...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/qmsolve-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13427&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/qmsolve-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `qmsolve` can be installed with:

```
conda install qmsolve
```

It is possible to list all of the versions of `qmsolve` available on your platform with:
